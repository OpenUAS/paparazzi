...
#warning Set USE_AIRSPEED_ETS to get data into the state or use AIRSPEED_ETS_SYNC_SEND to get airspeed_ets data fro debugging, or both
#endif
...
//Additional filter can be used, but mind the small lag in output
#ifdef AIRSPEED_ETS_USE_FILTER
